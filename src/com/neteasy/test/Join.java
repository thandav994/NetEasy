...
public class Join extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		Log.wtf("What the fuck","This class opened");
		...
		age = (EditText) findViewById(R.id.etDOB);
		email = (EditText) findViewById(R.id.etEmailId);
		country = (AutoCompleteTextView) findViewById(R.id.acCountry);
		Intersted=(EditText)findViewById(R.id.etInterested);
		Countries = getResources().getStringArray(R.array.countries);
		reg = (Button) findViewById(R.id.bRegister);
		adapter = new ArrayAdapter(Join.this,
